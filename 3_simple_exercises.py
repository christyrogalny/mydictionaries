...
#sampleDict has only one key = "class"
sampleDict = { 
   "class":{ 
      "student":{ 
         "name":"Mike",
...
#hard code if it asks you to set to a certain value
#its asking you to add 2 inches
...
dict['work'] = ["Apology", "Phaedo", "Republic", "Symposium"] #added new key value pair to our dictionary
print(dict)
